      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-4xl">
        {portfolio.projects.map((project, i) => (
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="flex flex-col justify-between p-5 rounded-xl border border-blue-900 bg-blue-950/10 hover:border-blue-500 hover:bg-blue-950/20 transition-all duration-300"
          >
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.map(tag => (
                  <span
                    key={tag}
                    className="text-xs px-2.5 py-1 rounded-full border border-blue-800 text-blue-300 bg-blue-950/30"
                  >
                    {tag}
                  </span>
                ))}
